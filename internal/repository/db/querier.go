...
type Querier interface {
	...
	GetEmployeeDashboardKPIs(ctx context.Context, arg GetEmployeeDashboardKPIsParams) (GetEmployeeDashboardKPIsRow, error)
	...
	GetMyExpenseStats(ctx context.Context, employeeID uuid.UUID) (GetMyExpenseStatsRow, error)
	...
	GetShiftsByLocationIDs(ctx context.Context, locationIds []uuid.UUID) ([]LocationShift, error)
	...
	ListEmployeeDashboardPendingRequests(ctx context.Context, arg ListEmployeeDashboardPendingRequestsParams) ([]ListEmployeeDashboardPendingRequestsRow, error)

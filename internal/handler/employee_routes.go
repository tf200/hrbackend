...
func RegisterEmployeeRoutes(
	...
	rg.GET(
		"/employees/:id/contract_changes",
		auth,
		requirePermission("EMPLOYEE.VIEW"),
		handler.ListContractChanges,
	)
	rg.POST(
		"/employees/:id/contract_changes",
		auth,
		requirePermission("EMPLOYEE.UPDATE"),
		handler.CreateContractChange,
	)
	rg.POST(
	...
	rg.GET(
		...
		auth,
		requirePermission("EMPLOYEE.VIEW"),
		handler.ListCertification,
	)
	rg.PUT(
		"/employees/:id/certification/:certification_id",
		auth,
		requirePermission("EMPLOYEE.UPDATE"),
		handler.UpdateCertification,
	)
	rg.DELETE(
		"/employees/:id/certification/:certification_id",
		auth,

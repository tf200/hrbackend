...
func (a *taskQueueAdapter) EnqueueEmailDelivery(ctx context.Context, payload domain.EmailDeliveryTaskPayload, opts *domain.TaskEnqueueOptions) error {
	return a.client.EnqueueEmailDelivery(toEmailDeliveryPayload(payload), ctx, toAsynqOptions(opts)...)
}
...
func (a *taskQueueAdapter) EnqueueNotificationTask(ctx context.Context, payload domain.NotificationTaskPayload, opts *domain.TaskEnqueueOptions) error {
	return a.client.EnqueueNotificationTask(ctx, toNotificationPayload(payload), toAsynqOptions(opts)...)
}
...
func toNotificationPayload(payload domain.NotificationTaskPayload) pkgasynq.NotificationPayload {
	return pkgasynq.NotificationPayload{
		...
		Data: pkgasynq.NotificationData{
			...
			ClientContractReminder:  toClientContractReminderData(payload.Data.ClientContractReminder),
			NewIncidentReport:       toNewIncidentReportData(payload.Data.NewIncidentReport),
			NewScheduleNotification: toNewScheduleNotificationData(payload.Data.NewScheduleNotification),
		},
...
func toNewClientAssignmentData(data *domain.NewClientAssignmentTaskData) *pkgasynq.NewClientAssignmentData {
	if data == nil {
		return nil
	}
...
func toClientContractReminderData(data *domain.ClientContractReminderTaskData) *pkgasynq.ClientContractReminderData {
	if data == nil {
		return nil
	}
...
func toNewIncidentReportData(data *domain.NewIncidentReportTaskData) *pkgasynq.NewIncidentReportData {
	if data == nil {
		return nil
	}
...
func toNewScheduleNotificationData(data *domain.NewScheduleNotificationTaskData) *pkgasynq.NewScheduleNotificationData {
	if data == nil {
		return nil
	}

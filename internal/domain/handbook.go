...
var (
	...
	ErrDraftTemplateAlreadyExists = errors.New(
		"a draft template already exists for this department",
	)
	...
	ErrTemplateHasNoSteps   = errors.New(
		"template must contain at least one step before publishing",
	)
	ErrStepNotFound       = errors.New("step not found")
	ErrInvalidStepReorder = errors.New(
		"ordered_step_ids must match the template steps exactly",
	)
...
type HandbookRepository interface {
	...
	GetActiveEmployeeHandbookByEmployeeID(
		ctx context.Context,
		employeeID uuid.UUID,
	) (*MyActiveHandbook, error)
	ListEmployeeHandbookStepsByHandbookID(
		ctx context.Context,
		handbookID uuid.UUID,
	) ([]MyHandbookStep, error)
	MarkEmployeeHandbookStarted(
		ctx context.Context,
		handbookID uuid.UUID,
	) (*EmployeeHandbookAssignment, error)
	CompleteEmployeeHandbookStep(
		ctx context.Context,
		params CompleteHandbookStepParams,
	) (*CompletedHandbookStep, error)
	CountRemainingRequiredHandbookSteps(ctx context.Context, handbookID uuid.UUID) (int32, error)
	MarkEmployeeHandbookCompleted(
		ctx context.Context,
		handbookID uuid.UUID,
	) (*EmployeeHandbookAssignment, error)
	CreateEmployeeHandbookAssignmentHistory(
		ctx context.Context,
		params CreateAssignmentHistoryParams,
	) error
	CreateHandbookTemplateForDepartment(
		ctx context.Context,
		actorEmployeeID uuid.UUID,
		params CreateTemplateForDepartmentParams,
	) (*HandbookTemplate, error)
	CloneHandbookTemplateToDraft(
		ctx context.Context,
		actorEmployeeID uuid.UUID,
		params CloneTemplateToDraftParams,
	) (*HandbookTemplate, error)
	GetHandbookTemplateByID(ctx context.Context, templateID uuid.UUID) (*HandbookTemplate, error)
	UpdateHandbookTemplateMetadata(
		ctx context.Context,
	...
	ListHandbookTemplatesByDepartment(
		ctx context.Context,
		departmentID uuid.UUID,
	) ([]HandbookTemplate, error)
	...
	CreateEmployeeHandbookFromTemplate(
		ctx context.Context,
		actorEmployeeID uuid.UUID,
		params AssignTemplateToEmployeeParams,
	) (*EmployeeHandbookAssignment, error)
	GetEmployeeHandbookByID(
		ctx context.Context,
		handbookID uuid.UUID,
	) (*EmployeeHandbookAssignment, error)
	WaiveEmployeeHandbookByID(
		ctx context.Context,
		handbookID uuid.UUID,
	) (*WaivedEmployeeHandbook, error)
	ListEmployeeHandbookAssignmentHistoryByEmployeeID(
		ctx context.Context,
		employeeID uuid.UUID,
		limit, offset int32,
	) ([]HandbookAssignmentHistoryEntry, error)
	ListEmployeeHandbookAssignments(
		ctx context.Context,
		params ListEmployeeHandbookAssignmentsParams,
	) (*EmployeeHandbookAssignmentPage, error)
	GetEmployeeHandbookDetailsByID(
		ctx context.Context,
		handbookID uuid.UUID,
	) (*EmployeeHandbookDetails, error)
	...
	GetEmployeeProfileByID(
		ctx context.Context,
		employeeID uuid.UUID,
	) (*HandbookEmployeeProfile, error)
	ListEligibleEmployeesForHandbookAssignment(
		ctx context.Context,
		params ListEligibleEmployeesParams,
	) (*EligibleEmployeePage, error)
}
...
type HandbookService interface {
	...
	CompleteMyHandbookStep(
		ctx context.Context,
		employeeID, stepID uuid.UUID,
		response []byte,
	) (*CompletedHandbookStep, error)
	CreateTemplateForDepartment(
		ctx context.Context,
		actorEmployeeID uuid.UUID,
		params CreateTemplateForDepartmentParams,
	) (*HandbookTemplate, error)
	...
	WaiveEmployeeHandbook(
		ctx context.Context,
		actorEmployeeID uuid.UUID,
		params WaiveEmployeeHandbookParams,
	) (*WaivedEmployeeHandbook, error)
	ListEmployeeHandbookHistory(
		ctx context.Context,
		employeeID uuid.UUID,
	) ([]HandbookAssignmentHistoryEntry, error)

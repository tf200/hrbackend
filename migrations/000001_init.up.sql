...
WITH seeded(name, sort_order) AS (
    VALUES
        ...
        ('SHIFT.UPDATE', 480),
        ('SHIFT.VIEW', 490),
        ('LATE_ARRIVAL.CREATE', 500),
        ('LATE_ARRIVAL.CREATE_ALL', 505),
        ('LATE_ARRIVAL.VIEW', 510),
        ('LATE_ARRIVAL.VIEW_ALL', 515),
        ('OVERTIME.CREATE', 520),
        ('OVERTIME.CREATE_ALL', 525),
        ('OVERTIME.DECIDE', 530),
        ('OVERTIME.DELETE', 532),
        ('OVERTIME.DELETE_ALL', 533),
        ('OVERTIME.UPDATE', 535),
        ('OVERTIME.UPDATE_ALL', 540),
        ('OVERTIME.VIEW', 545),
